...
public class MPasswordField extends PasswordField {
            ...
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if (newValue) {
                    setBorder(new Border(new BorderStroke(Color.web("#ff004e"), Color.web("#ff004e"),
                            Color.web("#fff"), Color.web("#ff004e"), BorderStrokeStyle.SOLID, BorderStrokeStyle.SOLID,
    ...
    private void setAppearance(){
        ...
        this.setBorder(new Border(new BorderStroke(Color.web("#ff004e"),
                Color.web("#ff004e"), Color.web("#cccccc"), Color.web("#ff004e"), BorderStrokeStyle.SOLID, BorderStrokeStyle.SOLID, BorderStrokeStyle.SOLID, BorderStrokeStyle.SOLID, new CornerRadii(0.0), BorderStroke.THIN, new Insets(0.0))));
    }
}
