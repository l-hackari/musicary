...
public class MButtonVariant extends Button {

    public MButtonVariant(){
        setAppearance();
    ...
    private void setMouseEventProperties(){
        this.setOnMousePressed(new EventHandler<MouseEvent>(){
            ...
            public void handle(MouseEvent event) {
                MButtonVariant.this.setEffect(new DropShadow(2.0, 0.0, 0.0, Color.web("#6b6b6b")));
            }
        });
        ...
        this.setOnMouseReleased(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                MButtonVariant.this.setEffect(new DropShadow(2.0, 0.0, 2.0, Color.web("#545454")));
            }
        });
    }
