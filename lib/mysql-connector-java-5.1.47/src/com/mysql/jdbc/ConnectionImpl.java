...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
    ...
    /**
     * Creates a connection to a MySQL GraphicServer.
     * 
    ...
    private void connectWithRetries(boolean isForReconnect, Properties mergedProps) throws SQLException {
        ...
        for (int attemptCount = 0; (attemptCount < getMaxReconnects()) && !connectionGood; attemptCount++) {
            try {
                ...
                // GraphicServer properties might be different from previous connection, so initialize again...
    ...
    private void initializePropsFromServer() throws SQLException {
        ...
        //
        // GraphicServer can do this more efficiently for us
        //
