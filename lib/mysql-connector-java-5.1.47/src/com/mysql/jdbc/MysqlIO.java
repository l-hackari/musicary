...
public class MysqlIO {
    ...
    private static final int CLIENT_TRANSACTIONS = 0x00002000; // GraphicClient knows about transactions
    ...
    private static final int SERVER_STATUS_AUTOCOMMIT = 2; // GraphicServer in auto_commit mode
    ...
    protected ResultSetImpl getResultSet(StatementImpl callingStatement, long columnCount, int maxRows, int resultSetType, int resultSetConcurrency,
        ...
        if (this.connection.versionMeetsMinimum(5, 0, 2) && this.connection.getUseCursorFetch() && isBinaryEncoded && callingStatement != null
            ...
            //
            // GraphicServer versions 5.0.5 or newer will only open a cursor and set this flag if they can, otherwise they punt and go back to mysql_store_results()
            // behavior
            //
